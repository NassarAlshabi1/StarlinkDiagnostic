...
def demo_get_status_data():
    ...
    status = {
        ...
        "bootcount": 42,
        "build_id": "demo-build",
        # V2.3 extended identity
        "board_rev": 3,
        "manufactured_version": "rev4_prod",
    ...
    alerts = {
        ...
        "alert_dbf_telem_stale": False,
        "alert_low_motor_current": False,
        "alert_lower_signal_than_predicted": False,
        "alert_slow_ethernet_speeds_100": st.slow_eth,
        "alert_obstruction_map_reset": False,
        "alert_dish_water_detected": False,
        "alert_router_water_detected": False,
        "alert_upsu_router_port_slow": False,
...
SAMPLE_GPS14 = {
    ...
    "build_id": None,
    "board_rev": None,
    "manufactured_version": None,
    "anti_rollback_version": None,
    "generation_number": None,
    "software_partitions_equal": None,
    "state": "CONNECTED",
    "uptime": 988,
    "snr": None,
...
SAMPLE_GPS14_ALERTS = {
    ...
    "alert_low_motor_current": False,
    "alert_lower_signal_than_predicted": False,
    "alert_slow_ethernet_speeds_100": False,
    "alert_obstruction_map_reset": False,
    "alert_dish_water_detected": False,
    "alert_router_water_detected": False,
    "alert_upsu_router_port_slow": False,
